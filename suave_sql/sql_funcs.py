...
class Tables: 
    ...
    def stints_run(self):
        ...
        with parts as (select distinct(participant_id), service_id, first_name, last_name, outreach_workers outreach_worker, service_start outreach_start from {self.table}
